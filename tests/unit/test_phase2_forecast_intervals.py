...
def test_empirical_intervals_use_sector_width_when_sample_is_sufficient() -> None:
    ...
    calibration = fit_empirical_intervals(frame, interval_level=0.95, minimum_group_observations=30)
...
def test_small_sector_group_uses_pooled_fallback() -> None:
    ...
    calibration = fit_empirical_intervals(frame, interval_level=0.90, minimum_group_observations=5)
